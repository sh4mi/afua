...
urlpatterns = [
    ...
    path('shop/<int:prod_id>/shop_View',accounts.views.shop_View, name='shopView'),
    path('shop_edit',accounts.views.shop_edit, name='editShop'),
    path("shop_details/", accounts.views.shop_details, name='detailShop'),
    path('shop/<int:shop_id>/add_product', accounts.views.add_product, name='AddProduct'),
    path('shop/<int:edit_id>/edit_product', accounts.views.edit_product, name='edit_product'),
